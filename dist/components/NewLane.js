...
/*#__PURE__*/
function (_Component) {
  (0, _inherits2.default)(NewLane, _Component);
  ...
  function NewLane() {
    ...
    (0, _classCallCheck2.default)(this, NewLane);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(NewLane)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  (0, _createClass2.default)(NewLane, [{
    key: "render",
